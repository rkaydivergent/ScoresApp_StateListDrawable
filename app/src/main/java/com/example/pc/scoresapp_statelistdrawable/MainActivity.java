package com.example.pc.scoresapp_statelistdrawable;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void decreaseScore(View view) {
        ...
        stateListDrawable.addState(new int[]{android.R.attr.state_pressed, android.R.attr.state_enabled}, getResources().getDrawable(R.drawable.pressed_button_bg));
        stateListDrawable.addState(new int[]{android.R.attr.state_focused}, getResources().getDrawable(R.drawable.pressed_button_bg));
        stateListDrawable.addState(new int[]{}, getResources().getDrawable(R.drawable.button_background));
